...
ryan = LINETCR.LINE()
#ryan.login(qr=True)
ryan.login(token='ErZTJ5hZxUib4y1cz8./xAA3piZkDNk7C2fd2YUQa.6VhsLGliwQ9vbCGIXOxkqYtJEbREyqaqksUeiy69Js4=')
ryan.loginResult()
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                link = ["http://dl.profile.line-cdn.net/0hsaE-C_aCLE54VACP3axTGUQRIiMPeioGAGVrLlpcIisHM2gaRjFrfVUGIioANj4RQDM0Lw8EJi5c"]
